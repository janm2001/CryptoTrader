...
public class LanguageService : INotifyPropertyChanged
{
    ...
    private readonly Dictionary<string, Dictionary<string, string>> _translations = new()
    {
        ["en"] = new Dictionary<string, string>
        {
            ...
            ["SelectFromHoldings"] = "Select from Your Holdings",
            ["YouOwn"] = "You Own",
            ["Selling"] = "Selling",
            ...
            ["PlanCreated"] = "DCA plan created successfully!",
            ["PlanUpdated"] = "DCA plan updated successfully!",
            ["PlanDeleted"] = "DCA plan deleted!",
            ...
            ["DCAInfo"] = "What is DCA?",
            ["DCADescription"] = "Dollar-Cost Averaging (DCA) is an investment strategy where you invest fixed amounts at regular intervals, regardless of price. This reduces the impact of volatility and removes the stress of timing the market.",
        },
        ...
        ["hr"] = new Dictionary<string, string>
        {
            ...
            ["UploadPicture"] = "Učitaj sliku",
            ["RemovePicture"] = "Ukloni sliku",
            ["SelectImage"] = "Odaberi sliku",
            ["ImageUploaded"] = "Slika uspješno učitana!",
            ["ImageRemoved"] = "Profilna slika uklonjena",
            ["ImageTooLarge"] = "Slika prevelika (max 2MB)",
            ["InvalidImageType"] = "Neispravan tip slike",
            ...
            // Buy/Sell
            ["BuyCrypto"] = "Kupi kriptovalutu",
            ["SellCrypto"] = "Prodaj kriptovalutu",
            ["SelectCrypto"] = "Odaberi kriptovalutu",
            ["AvailableBalance"] = "Raspoloživi saldo",
            ["CurrentBalance"] = "Trenutni saldo",
            ["AmountToBuy"] = "Količina za kupnju",
            ["AmountToSell"] = "Količina za prodaju",
            ["TotalCost"] = "Ukupni trošak",
            ["YoullReceive"] = "Primit ćete",
            ["BuyNow"] = "Kupi sada",
            ["SellNow"] = "Prodaj sada",
            ["SellAll"] = "Prodaj sve",
            ["InsufficientBalance"] = "Nedovoljan saldo!",
            ["InsufficientHoldings"] = "Nedovoljna sredstva!",
            ["PurchaseSuccessful"] = "Kupnja uspješna!",
            ["SaleSuccessful"] = "Prodaja uspješna!",
            ["Processing"] = "Obrada...",
            ["SelectFromHoldings"] = "Odaberi iz svojih ulaganja",
            ["YouOwn"] = "Posjedujete",
            ["Selling"] = "Prodaja",
            ["PortfolioValue"] = "Vrijednost portfelja",
            ["TotalAssets"] = "Ukupna imovina",
            ["MyPortfolio"] = "Moj portfelj",
            
            // DCA (Dollar Cost Averaging)
            ["NavDCA"] = "DCA planovi",
            ["DCAPlans"] = "DCA planovi",
            ["CreateNewPlan"] = "Kreiraj novi plan",
            ["EditPlan"] = "Uredi plan",
            ...
            ["ActivePlans"] = "Aktivnih planova",
            ["TotalInvested"] = "Ukupno uloženo",
            ["ToggleActive"] = "Uključi/Isključi",
            ["PlanCreated"] = "DCA plan uspješno kreiran!",
            ["PlanUpdated"] = "DCA plan uspješno ažuriran!",
            ["PlanDeleted"] = "DCA plan obrisan!",
            ...
            ["DCAInfo"] = "Što je DCA?",
            ["DCADescription"] = "Dollar-Cost Averaging (DCA) je investicijska strategija gdje ulažete fiksne iznose u redovitim intervalima, bez obzira na cijenu. Ovo smanjuje utjecaj volatilnosti i uklanja stres od pokušaja da 'uhvatite' pravi trenutak na tržištu.",
        }
    };
